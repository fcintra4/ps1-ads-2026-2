...
@Entity @Table(name = "customers") public class Customers {
   ...
   @Column(name = "ident_document", nullable = false, unique = true) private String identDocument;
   @Column(name = "birth_date") private LocalDate birthDate;
   @Column(name = "street_name", nullable = false) private String streetName;
   @Column(name = "house_number", nullable = false) private String houseNumber;
   @Column(name = "complements", nullable = true) private String complements;
   @Column(name = "district", nullable = false) private String district;
   @Column(name = "municipality", nullable = false) private String municipality;
